...
List.prototype = {
    ...
    fillList: function (lastPosition, newPosition) {
        // todo mark items as invisible

        // todo find min & max real visible index

        // todo if we don't have visible items

        // todo fill bottom part by new items

        // todo fill top part by new items
